...
<head>
    ...
    <title>LearnZone Contact Us</title>
    <link rel="icon" href="img/online-education.png" type="image/icon type">
    <link rel="icon" href="img/ucation.png" type="image/icon type">
...
<body>
    <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="#"><img src="img/online-education.png" height="30" width="41"></a>
            ...
            <div class="col-12 col-sm-4 offset-sm-1">
                   <h5>Our Address</h5>
                    <address style="font-size: 100%">
		              ...
		              Calicut<br>
		              Kerala<br>
		              <i class="fa fa-phone"></i>: +91 7556798456<br>
		              <i class="fa fa-fax"></i>: +852 8765 4321<br>
		              <i class="fa fa-envelope"></i>:
                        <a href="mailto:Ishank@nitc.ac.in">LearnZone@study.net</a>
		           </address>
            </div>
            
            <div class="col-12 col-sm-11 offset-sm-1">
                <div class="btn-group" role="group">
					<a role="button" class="btn btn-primary" href="tel:+91 7556798456"><i class="fa fa-phone"></i>Call</a>
					<a role="button" class="btn btn-info">Skype<i class="fa fa-skype"></i></a>
					<a role="button" class="btn btn-success" href="mailto:Ishank@nitc.ac.in">Email<i class="fa fa-envelope-o"></i></a>
				</div>
            </div>
        </div>
